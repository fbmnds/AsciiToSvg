...
module LineScanner =
  ...
  module TestMiniBox_txt =
    ...
    let allLinesExpected =
      ([|{ orientation = Horizontal; gridCoordStart = {col = 1; row = 0;}; gridCoordEnd = {col = 1; row = 0;}; linechars = [|'-'|]; lineOptions = Map.empty };
         { orientation = Horizontal; gridCoordStart = {col = 1; row = 2;}; gridCoordEnd = {col = 1; row = 2;}; linechars = [|'-'|]; lineOptions = Map.empty }|],
       [|{ orientation = Vertical; gridCoordStart = {col = 0; row = 1;}; gridCoordEnd = {col = 0; row = 1;}; linechars = [|'|'|]; lineOptions = Map.empty };
         { orientation = Vertical; gridCoordStart = {col = 2; row = 1;}; gridCoordEnd = {col = 2; row = 1;}; linechars = [|'|'|]; lineOptions = Map.empty }|])
